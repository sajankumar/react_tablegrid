...
var _tableFooter = __webpack_require__(9);

var _tableFooter2 = _interopRequireDefault(_tableFooter);

var _tableFilter = __webpack_require__(10);
...
var TableGrid = function (_React$Component) {
  _inherits(TableGrid, _React$Component);

  function TableGrid(props) {
    _classCallCheck(this, TableGrid);

    var _this = _possibleConstructorReturn(this, (TableGrid.__proto__ || Object.getPrototypeOf(TableGrid)).call(this, props));

    _this.tableConfig = Object.assign({
      isSorting: false,
      data: [],
      isRowSelection: false,
      filterBy: ''
    }, _this.props.tableConfig);
    _this.update = _this.update.bind(_this);
    _this.onSearch = _this.onSearch.bind(_this);
    _this.state = {
      showTable: _this.tableConfig.data.length === 0 ? false : true,
      data: _this.tableConfig.data
    };
    _this.sortType = 'asc';
    _this.originalData = lodash.clone(_this.props.tableConfig.data);
    if (_this.tableConfig.isRowSelection && !_this.tableConfig.onRowSelect) {
      throw new Error('Row Selection is enabled, It is required a callback function.');
    }
    return _this;
  }

  _createClass(TableGrid, [{
    key: 'showTableMsg',
    value: function showTableMsg() {
    ...
    key: 'sortHandler',
    value: function sortHandler(evt, index) {
      var key = Object.keys(this.state.data[0])[index];

      var sortObj = null;
      if (this.sortType === 'asc') {
        sortObj = lodash.sortBy(this.tableConfig.data, function (a) {
    ...
    key: 'showTableHeader',
    value: function showTableHeader() {
      return _react2.default.createElement(_tableHeader2.default, { headers: Object.keys(this.state.data[0] || []),
    ...
    key: 'showTableBody',
    value: function showTableBody() {
      return _react2.default.createElement(_tableBody2.default, { data: this.state.data,
        isRowSelection: this.tableConfig.isRowSelection,
        onRowSelect: this.tableConfig.onRowSelect });
    }
  }, {
    key: 'showTableFooter',
    value: function showTableFooter() {
      return _react2.default.createElement(_tableFooter2.default, { data: this.state.data, updateData: this.update, recordPerPage: 5 });
    }
  }, {
    key: 'update',
    ...
    value: function onSearch(evt) {
      var filterBy = this.tableConfig.filterBy;
      var filtered = [];
      if (!evt.target.value) {
        ...
        filtered = lodash.filter(this.state.data, function (item) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_tableFilter2.default, { changeEvent: this.onSearch, isSearch: this.tableConfig.isSearch }),
...
var TableHeader = function (_React$Component) {
  ...
  _createClass(TableHeader, [{
    key: 'showSorting',
    value: function showSorting() {
      return _react2.default.createElement('i', { className: 'fa fa-sort',
        style: this.styles });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      if (this.state.headers.indexOf('selectedRow') !== -1) {
        var keys = this.props.headers.splice(0, this.props.headers.indexOf('selectedRow'));
        this.setState({ headers: keys });
      }
      var headers = this.state.headers;
      var sorting = this.props.isSorting ? this.showSorting() : null;
      var element = headers.map(function (value, index) {
        return headers.length !== 0 ? _react2.default.createElement(
          'th',
          { className: 'column',
            key: 'headers_' + index,
            onClick: function onClick(evt) {
              return _this2.props.onSortHandler(evt, index);
            } },
          ' ',
          value,
          sorting
...
var TableBody = function (_React$Component) {
  ...
  function TableBody(props) {
    ...
    _this.onRowHandler = _this.onRowHandler.bind(_this);
    _this.reset = _this.reset.bind(_this);
    _this.state = {
      data: _this.props.data,
      isRowSelection: _this.props.isRowSelection,
      selectedRow: null
    };
    _this.styles = {
  ...
  _createClass(TableBody, [{
    ...
    value: function reset() {
      lodash.forEach(this.state.data, function (item) {
        if (item.selectedRow) {
    ...
    key: 'onRowHandler',
    value: function onRowHandler(ev, item) {
    ...
    value: function render() {
      ...
      var element = datas.map(function (item, index) {
        return _react2.default.createElement(
          'tr',
          { key: index, onClick: function onClick(evt) {
              return _this2.onRowHandler(evt, item);
            },
            style: _this2.state.data[index].selectedRow ? _this2.styles : null },
...
var TableFooter = function (_React$Component) {
  ...
  _createClass(TableFooter, [{
    ...
    value: function updatePage(page) {
      ...
      for (var i = (page - 1) * this.config.recordPerPage; i < page * this.config.recordPerPage && i < this.config.data.length; i++) {
...
var TableFilter = function (_React$Component) {
  ...
  function TableFilter(props) {
    ...
    if (!_this.props.changeEvent) {
      throw new Error('Event Call back is requried!', _this);
    }
    _this.state = {
      isSearch: _this.props.isSearch || false
    };
    return _this;
  }
  ...
  _createClass(TableFilter, [{
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { type: 'text',
          ...
          onChange: function onChange(evt) {
            evt.persist();_this2.props.changeEvent(evt);
          },
          className: 'searchBox'
        })
      );
    ...
    key: 'render',
    value: function render() {
      var element = this.state.isSearch ? this.search() : null;
      return element;
    }
  }]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./tableGrid.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./tableGrid.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".headContainer, .bodyContainer {\r\n  width: 100%;\r\n  border-spacing: inherit;\r\n}\r\n.columns {\r\n  background-color: hsl(0, 0%, 21%);\r\n}\r\n.columns tr .column {\r\n  padding: 5px;\r\n  text-align: justify;\r\n  color: #FFFFFF;\r\n  border-bottom: 1px solid hsl(0, 0%, 21%);\r\n  font-size: 14px;\r\n}\r\n\r\n.bodyContainer tr {\r\n  text-align: justify;\r\n}\r\n.bodyContainer tr td {\r\n  padding: 5px;\r\n  border-bottom: 1px solid hsla(0, 0%, 21%, 0.164);\r\n}\r\n\r\n.bodyContainer tr:hover {\r\n  background-color: hsla(204, 86%, 53%, 0.45);\r\n}\r\n.highlight {\r\n  background-color: 'hsl(204, 86%, 53%)';\r\n}\r\n\r\n.footerContainer .pagination {\r\n  display: flex;\r\n  justify-content: center;\r\n  align-items: center;\r\n  flex-direction: row-reverse;\r\n}\r\n\r\n.footerContainer .pagination p {\r\n  margin-left: 10px;\r\n  margin-right: 10px;\r\n}\r\n\r\n.filterContainer {\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: right;\r\n  flex-direction: row-reverse;\r\n}\r\n.filterContainer .searchBox {\r\n  margin: 10px;\r\n  margin: 10px;\r\n  height: 15px;\r\n  padding: 5px;\r\n}", ""]);
